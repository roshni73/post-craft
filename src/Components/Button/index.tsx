...
export const Button: React.FC<ButtonProps> = ({
  ...
  if (variant === "default") {
    dynamicVariantClasses =
      mode === "light" ? "bg-black text-white border border-black" : "bg-primary text-primary-foreground";
    ...
    dynamicVariantClasses = mode === "light" ? "text-primary underline-offset-4 hover:underline" : "text-white underline-offset-4 hover:underline";
  }
